...
class AddTheseComponent extends Component{
    ...
    saveThese (e) {
        e.preventDefault();
        let these = {title: this.state.title, profsName: this.state.profsName, studentName: this.state.studentName,annee: this.state.annee ,description: this.state.description};

           axios.post('http://localhost:8002/api/add',these)
            .then(res => {
